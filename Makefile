# This Makefile is for the Win32::Process::Hide extension to perl.
#
...
#     ABSTRACT_FROM => q[lib/Win32/Process/Hide.pm]
...
#     LD => q[g++]
#     LIBS => [q[]]
#     NAME => q[Win32::Process::Hide]
#     PREREQ_PM => {  }
#     VERSION_FROM => q[lib/Win32/Process/Hide.pm]
#     XSOPT => q[-C++]
...
MAKE = nmake
FULLEXT = Win32\Process\Hide
BASEEXT = Hide
PARENT_NAME = Win32::Process
DLBASE = $(BASEEXT)
VERSION_FROM = lib/Win32/Process/Hide.pm
INC = -I.
DEFINE = 
...
H_FILES  = 
MAN1PODS = 
MAN3PODS = lib/Win32/Process/Hide.pm
...
TO_INST_PM = lib/Win32/Process/Hide.pm

PM_TO_BLIB = lib/Win32/Process/Hide.pm \
	blib\lib\Win32\Process\Hide.pm
...
XSUBPPARGS = -C++ -typemap C:\Perl\lib\ExtUtils\typemap
XSUBPP_EXTRA_ARGS = 
...
# Win32::Process::Hide might depend on some other libraries:
...
Hide.def: Makefile.PL
	$(PERLRUN) -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME'=>\"Win32::Process::Hide\", 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
OTHERLDFLAGS = -Wl,--image-base,0x660d0000 
INST_DYNAMIC_DEP = 
...
manifypods : pure_all  \
	lib/Win32/Process/Hide.pm
	$(NOECHO) $(POD2MAN) --section=3 --perm_rw=$(PERM_RW) \
	  lib/Win32/Process/Hide.pm $(INST_MAN3DIR)\Win32.Process.Hide.$(MAN3EXT) 
...
pm_to_blib : $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e "pm_to_blib({@ARGV}, '$(INST_LIB)\auto', '$(PM_FILTER)')" -- \
	  lib/Win32/Process/Hide.pm blib\lib\Win32\Process\Hide.pm 
